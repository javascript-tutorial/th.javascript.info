...
ซึ่งช่วยให้เราสร้างฟังก์ชันใหม่ที่อยู่ตรงกลางของนิพจน์ใดๆก็ได้
...
ขอย้ำอีกครั้งว่า ไม่ว่าฟังก์ชันจะถูกสร้างขึ้นอย่างไร ฟังก์ชันก็คือค่า ค่าหนึ่ง ทั้งสองตัวอย่างด้านบนเก็บฟังก์ชันไว้ในตัวแปร `sayHi`

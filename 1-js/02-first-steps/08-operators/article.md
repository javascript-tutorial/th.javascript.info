...
ตัวดำเนินการเครื่องหมายจุลภาค `,` เป็นหนึ่งในตัวดำเนินการที่พบได้ยากและแปลกประหลาดที่สุด บางครั้งคนใช้มันเพื่อเขียนโค้ดให้สั้นลง เราจึงจำเป็นต้องรู้จักไว้เพื่อให้เข้าใจว่าโค้ดกำลังทำอะไร

ตัวดำเนินการเครื่องหมายจุลภาคทำให้เราสามารถประเมินนิพจน์ได้หลายตัว โดยคั่นด้วยเครื่องหมายจุลภาค `,` แต่ละนิพจน์จะถูกประเมินผล แต่จะส่งเฉพาะผลลัพธ์ของนิพจน์ตัวสุดท้ายกลับมา
...
ในตัวอย่างนี้ นิพจน์แรก `1 + 2` จะถูกประเมินผลแต่ทิ้งผลลัพธ์ไป จากนั้น `3 + 4` จึงถูกประเมินและส่งค่ากลับมาเป็นผลลัพธ์
...
บางครั้งคนใช้มันในโครงสร้างที่ซับซ้อนกว่า เพื่อรวมหลายการกระทำไว้ในบรรทัดเดียว
...
เทคนิคเช่นนี้ถูกใช้ในหลายเฟรมเวิร์กของ JavaScript นั่นเป็นเหตุผลที่เรากล่าวถึงมัน แต่โดยทั่วไปแล้วมันไม่ได้ช่วยให้โค้ดอ่านง่ายขึ้นเลย เราควรคิดให้ดีก่อนนำมาใช้
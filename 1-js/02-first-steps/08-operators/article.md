## ตัวดำเนินการพื้นฐาน, คณิตศาสตร์

พวกเราทุกคนรู้จักตัวดำเนินการทางคณิตศาสตร์มาตั้งแต่สมัยเรียน เช่น บวก `+` คูณ `*` ลบ `-` และอื่นๆ

ในบทนี้ เราจะเริ่มต้นด้วยตัวดำเนินการง่ายๆ จากนั้นมุ่งเน้นไปที่ส่วนเฉพาะของ JavaScript ที่ไม่ได้ครอบคลุมในวิชาเลขที่โรงเรียน

## คำศัพท์: "unary", "binary", "operand"

ก่อนที่เราจะไปต่อ เรามาทำความเข้าใจคำศัพท์ทั่วไปบางคำกันก่อน

- *โอเปอร์แรนด์ (operand)* - คือสิ่งที่ตัวดำเนินการถูกนำไปใช้ ตัวอย่างเช่น ในการคูณ `5 * 2` มีโอเปอร์แรนด์สองตัวคือโอเปอร์แรนด์ซ้าย คือ `5` และโอเปอร์แรนด์ขวา คือ `2` บางครั้ง ผู้คนเรียกสิ่งเหล่านี้ว่า "อาร์กิวเมนต์" แทนที่จะเป็น "โอเปอร์แรนด์"
- ตัวดำเนินการเป็น *unary* ถ้ามันมีโอเปอร์แรนด์เพียงตัวเดียว ตัวอย่างเช่น การเปลี่ยนเครื่องหมายแบบ unary `-` จะกลับเครื่องหมายของตัวเลข:
    ...
    */!*
    ...
    ```
- ตัวดำเนินการเป็น *binary* ถ้ามันมีโอเปอร์แรนด์สองตัว เครื่องหมายลบเดียวกันนี้มีอยู่ในรูปแบบ binary ด้วยเช่นกัน:
  ...
  เอาจริง ๆ ในตัวอย่างข้างต้น เราใช้ตัวดำเนินการสองตัวที่ใช้สัญลักษณ์เดียวกัน: ตัวดำเนินการเปลี่ยนเครื่องหมาย ซึ่งเป็นตัวดำเนินการแบบ unary ที่กลับเครื่องหมาย และตัวดำเนินการลบ ซึ่งเป็นตัวดำเนินการแบบ binary ที่ลบตัวเลขหนึ่งออกจากอีกตัว

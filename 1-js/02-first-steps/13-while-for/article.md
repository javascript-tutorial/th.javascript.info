...
ในการสร้างลูป "ไม่มีที่สิ้นสุด" มักจะใช้โครงสร้าง `while(true)` ลูปลักษณะนี้ เช่นเดียวกับลูปอื่นๆ สามารถหยุดได้ด้วยคำสั่ง `break` 

หากเราไม่ต้องการทำอะไรในรอบปัจจุบัน และต้องการข้ามไปยังรอบถัดไป เราสามารถใช้คำสั่ง `continue`

`break/continue` รองรับการใช้ label ที่อยู่ข้างหน้าลูป label เป็นวิธีเดียวที่ `break/continue` จะสามารถออกจากลูปที่ซ้อนกันเพื่อไปยังลูปชั้นนอกได้

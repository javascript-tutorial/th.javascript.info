...
- `NaN` คือ ค่าที่เกิดขึ้นจากข้อผิดพลาดทางการคำนวณ เป็นผลมาจากการดำเนินการทางคณิตศาสตร์ที่ไม่ถูกต้อง ตัวอย่างเช่น
    ...
    หากค่าใดเป็น `NaN` แล้ว เราจะใช้ตัวดำเนินการทางคณิตศาสคร์ใดๆกับ `NaN` ก็จะได้ `NaN` ออกมาอยู่ดี:
    ...
    ดังนั้น หากเกิด `NaN` ขึ้นมาในโค้ดของเรา มันก็อาจจะลามไปที่อื่นในโค้ดของเราด้วย ยกเว้นเราจะใช้ `NaN ** 0` เราจะได้ `1`

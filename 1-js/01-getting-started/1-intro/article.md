...
JavaScript ในเบราว์เซอร์มีข้อจำกัดด้านความสามารถ เพื่อปกป้องความปลอดภัยของผู้ใช้ โดยมีจุดประสงค์เพื่อกันไม่ให้หน้าเว็บที่ไม่น่าไว้วางใจเข้าถึงข้อมูลส่วนตัว หรือทำให้ข้อมูลของผู้ใช้เสียหาย
...
- JavaScript ในหน้าเว็บไม่สามารถอ่าน/เขียน/คัดลอกไฟล์ในฮาร์ดดิสก์ หรือเรียกโปรแกรมอื่นๆ ได้โดยตรง ไม่มีสิทธิ์เข้าถึงฟังก์ชันระบบของระบบปฏิบัติการโดยตรง
    ...
    เบราว์เซอร์รุ่นใหม่อนุญาตให้ทำงานกับไฟล์ได้บ้าง แต่การเข้าถึงถูกจำกัดอย่างเข้มงวดและต้องได้รับความยินยอมจากผู้ใช้ก่อน เช่น การ "ลาก" ไฟล์มาวางในหน้าเว็บ หรือเลือกผ่านแท็ก `<input>`
...
- แท็บ/วินโดว์ต่างๆ โดยปกติแล้วไม่รู้จักกัน แม้บางครั้งอาจทำได้ เช่นเมื่อหน้าต่างหนึ่งใช้ JavaScript เปิดหน้าต่างอื่นขึ้นมา แต่แม้ในกรณีนี้ JavaScript จากหน้าหนึ่งก็ยังไม่สามารถเข้าถึงอีกหน้าได้ หาก URL นั้นมาจากโดเมน โปรโตคอล หรือพอร์ตที่ต่างกัน นโยบายนี้เรียกว่า "Same Origin Policy"
    ...
    การแลกเปลี่ยนข้อมูลระหว่างหน้าเว็บจะทำได้ก็ต่อเมื่อ *ทั้งสองฝ่ายตกลงยินยอม* และต้องใช้โค้ด JavaScript พิเศษเพื่อจัดการ ซึ่งเราจะพูดถึงในบทเรียนข้างหน้า
...
- JavaScript ติดต่อกับเซิร์ฟเวอร์ต้นทางของหน้านั้นได้สะดวก แต่การรับข้อมูลจากโดเมนหรือไซต์อื่นถูกจำกัดไว้ ทำได้แต่ต้องมีข้อตกลงชัดเจนจากเซิร์ฟเวอร์ปลายทาง (ผ่าน HTTP header) ซึ่งก็เป็นมาตรการด้านความปลอดภัยอีกเช่นกัน
...
JavaScript มีอย่างน้อย *3 จุดเด่น* ที่ไม่มีใครเหมือน:
...
นั่นจึงทำให้ JavaScript กลายเป็นเครื่องมือยอดนิยมสำหรับสร้างส่วนติดต่อผู้ใช้บนเบราว์เซอร์
